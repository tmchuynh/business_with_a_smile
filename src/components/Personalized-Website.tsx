...
const reasons = [
    {
        ...
        icon: <CheckIcon className="h-7 w-7 text-white dark:text-gray-900" />,
    },
    {
        ...
        icon: <LockIcon className="h-7 w-7 text-white dark:text-gray-900" />,
    },
    {
        ...
        icon: <ShieldIcon className="h-7 w-7 text-white dark:text-gray-900" />,
    },
    {
        ...
        icon: <CloudIcon className="h-7 w-7 text-white dark:text-gray-900" />,
    },
    {
        ...
        icon: <DatabaseIcon className="h-7 w-7 text-white dark:text-gray-900" />,
    },
    {
        ...
        icon: <ServerIcon className="h-7 w-7 text-white dark:text-gray-900" />,
    },
    {
        ...
        icon: <WifiIcon className="h-7 w-7 text-white dark:text-gray-900" />,
    },
    {
        ...
        <div className="bg-white dark:bg-softGray-900 py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    <h2 className="text-base font-semibold text-teal-600 dark:text-deepBlue-400">Key Foundations</h2>
                    ...
                    <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3 lg:gap-y-16">
                        {reasons.map( ( feature, index ) => (
                            <div key={index} className="relative pl-16">
                                <dt className="text-base font-semibold text-gray-900 dark:text-deepBlue-400">
                                    <div className="absolute left-0 top-0 flex items-center justify-center rounded-lg bg-teal-600 dark:bg-deepBlue-300 p-2 ">
                                        {feature.icon}
                                    </div>
                                    {feature.title}
                                </dt>
                                <dd className="mt-2 text-base text-gray-600 dark:text-gray-200">{feature.description}</dd>
                            </div>
                        ) )}
                    </dl>
                </div>
