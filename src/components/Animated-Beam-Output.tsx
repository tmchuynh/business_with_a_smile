...
>( ( { className, children }, ref ) => {
    return (
        <div
            ref={ref}
            className={cn(
                "z-10 flex size-12 items-center justify-center rounded-full border-2 border-deepTeal-600 dark:border-deepBlue-400 bg-white dark:bg-softGray-900 p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
                className,
            )}
        >
            {children}
