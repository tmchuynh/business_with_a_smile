...
>( ( { className, children, size = "12" }, ref ) => (
    <div
        ref={ref}
        className={cn(
            `z-10 flex size-${ size } items-center justify-center rounded-full border-2 border-deepTeal-600 dark:border-deepBlue-400 bg-white dark:bg-softGray-900 p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]`,
            className
        )}
    >
        {children}
...
export function AnimatedBeamMultipleOutputDemo( { className }: { className?: string; } ) {
    ...
    return (
        <div
            className={cn(
                "relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg border border-deepTeal-600 dark:border-deepBlue-400 bg-background p-10 md:shadow-xl",
                className
            )}
            ref={containerRef}
        >
            <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
                <div className="flex flex-col justify-center gap-2">
                    {["googleDrive", "googleDocs", "whatsapp", "messenger", "notion"].map( ( icon, index ) => (
                        <Circle key={index} ref={divRefs[index]} size="12">
                            {Icons[icon as keyof typeof Icons]()}
                        </Circle>
                    ) )}
                </div>
                <div className="flex flex-col justify-center">
                    <Circle ref={divRefs[5]} size="16">
                        {Icons.openai()}
                    </Circle>
                </div>
                <div className="flex flex-col justify-center">
                    <Circle ref={divRefs[6]} size="12">
                        {Icons.user()}
                    </Circle>
                </div>
            </div>
